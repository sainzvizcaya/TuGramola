...
import tablerocolores.cfic.edu.tugramola.dto.DescargarCanciones;
...
public class MainActivity1 extends AppCompatActivity {
    ...
    public static void setPlayButton(ImageView playButton) {MainActivity1.playButton = playButton;}

    public static MediaPlayer getReproductor() {return reproductor;}

    public static void setReproductor(MediaPlayer reproductor) {MainActivity1.reproductor = reproductor;}

    public static boolean isPlay() {return play; }

    public static void setPlay(boolean play) { MainActivity1.play = play; }
